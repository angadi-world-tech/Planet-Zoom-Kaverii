...
import com.angadi.tripmanagementa.LocationJobService;
...
public class Location_Tracker extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_location__tracker);
     ...
     //   bService = (Button) findViewById(R.id.b_service);
        ...
        mapFragment.getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(GoogleMap googleMap) {
                mMap = googleMap;
                CameraUpdate point = CameraUpdateFactory.newLatLngZoom(new LatLng(12.972442,77.580643),8);
        ...
        LinLayoutBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent= new Intent(Location_Tracker.this,HomeActivity.class);
                ...
                switch (statusCode) {
                    case CommonStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            resolvable.startResolutionForResult(Location_Tracker.this,
    ...
    private void updateMarker(Location location) {
        ...
        if(mMap!=null && mapLoaded){
            if(carMarker==null) {
                ...
                BitmapDescriptor car = BitmapDescriptorFactory.fromResource(R.drawable.ic_car);
