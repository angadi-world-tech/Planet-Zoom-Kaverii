...
public class SubCategoryViewAllAdapter extends RecyclerView.Adapter<SubCategoryViewAllAdapter.ViewHolder> {
    ...
    public SubCategoryViewAllAdapter(ArrayList<SubProduct> SubProductArrayList, Context mContext) {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int i) {
            ...
            viewHolder.cust_txt_product_edit.setVisibility(View.GONE);
            viewHolder.cust_txt_product_delete.setVisibility(View.GONE);
            viewHolder.cust_img_edit.setVisibility(View.GONE);
            viewHolder.cust_img_delete.setVisibility(View.GONE);
            ...
            Log.d("checkidds ","Adap : "+Constant.formatDate(SubProductArrayList.get(i).getTime_date()));
