...
public class SubCategoryEditAllAdapter extends RecyclerView.Adapter<SubCategoryEditAllAdapter.ViewHolder> {
    ...
    public SubCategoryEditAllAdapter(ArrayList<SubProduct> SubProductArrayList, Context mContext) {
